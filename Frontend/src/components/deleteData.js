...
export default function DeleteForm({openn,handleClosee, handleDelete}) {
  return (
    <div>
      <Dialog
        open={openn}
      ...
      >
        ...
        <DialogActions>
          <Button variant="outlined" onClick={handleClosee} color="primary" style={{width:'200px',right:'0%', color:'white', border: "1px solid white"}}>
            CANCEL
          </Button>
